...
def compare_with_database(frame, database_folder="database/database"):
    ...
    for face, x, y, w, h in giveAllFaces(frame):
        ...
        putBoxText(frame, x, y, w, h, text=name + "({})".format(prob_text))
